...
prepare_data <- function(editions) {
    
    data_longer <- load_data() |>
...
prepare_data_satunsatcombined <- function(editions) {
...
plot_raupcr_for_editions <- function(editions) {
    ...
    data_longer <- prepare_data_satunsatcombined(editions)
