...
ggsave(plot = plot_max_small,
       filename = "plots/thesis/historical_anyexceptmax_raupcr_ALL_CLASSES-groupingcombined-other.png",
       device = "png", width = 300, height = 90, units = "mm", dpi = "print"
)
