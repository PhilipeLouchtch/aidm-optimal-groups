...
plot_gsb <- function() {
    ...
    plot <- ggplot(filtered_data,
                   aes(x = interaction(mechanism_short, num_students),
                       y = ceiling(duration_ms / 1000),
                       group = interaction(mechanism_short, num_students),
...
ggsave(plot = plot_gsb(),
       filename = "plots/thesis/synth_gsb_runtimes.png",
